...
import { enforce, getAllowedTypes } from "../enforcers/rbacHandmadeEnforcerSQLAccelerated.js";


class CliRbacHandmadeSQLAccelerated extends CLI {
  constructor(...args) {
    super(...args)
...
export default CliRbacHandmadeSQLAccelerated;
